...
int main()
{
	...
	*pos=0;
	...
	mlx_proto_change_rolling_text(2, " ");
	sleep(2);
	mlx_proto_change_rolling_text(2, "Master Data Syncing...");
	sleep(2);
						
	
	strcat(curl_sec_final,mac_id);
	strcat(curl_sec_final,"/master/");
	...
	strcat(curl_sec_final,"/");
	strcat(curl_sec_final," >/www/usbshare/udisk/download/master.zip");
	...
	mlx_proto_change_rolling_text(2, " ");
	sleep(2);
	mlx_proto_change_rolling_text(2, "Master Data Synced with KenCloud");
	sleep(2);
	...
	else
	{
		connect_count++;	
			...
			mlx_proto_change_rolling_text(2, " ");	
			sleep(1);
			mlx_proto_change_rolling_text(2, "Check connectivity");			
	}
